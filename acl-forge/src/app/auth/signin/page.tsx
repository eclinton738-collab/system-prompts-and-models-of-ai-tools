    ...
    <div className="min-h-screen bg-forge-bg flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="font-bebas text-6xl tracking-widest text-forge-text mb-2">
        ...
        {/* Auth card */}
        <div className="forge-modal p-8 space-y-4">
          <h2 className="font-bebas text-2xl tracking-widest text-center text-forge-text mb-6">
            ACCESS THE FORGE
          </h2>
        ...
        <p className="text-center text-forge-muted text-xs font-mono mt-6 opacity-50">
          Professional AI documentary editing for ACL fighters
        </p>
      </div>
    </div>
  )
